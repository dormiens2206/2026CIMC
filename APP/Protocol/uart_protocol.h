...
/* #define CMD_RESTORE     0x0102  //恢复出厂设置   */
#define CMD_VERSION_Q    0x0104  //查询版本
...
//数据类0x02
#define CMD_CH0_Q    0x0201  //查询CH0  v1
#define CMD_CH1_Q    0x0202  //查询CH1  v2
#define CMD_CH2_Q    0x0203  //查询CH2  A
#define CMD_CH0_SET  0x0241  //设置CH0变比
#define CMD_CH1_SET  0x0242  //设置CH1变比
#define CMD_CH2_SET  0x0243  //设置CH2变比
...
#define CMD_BACK_Q      0x0504  //版本回退请求，返回前一版本，Bootloader区下发
#define CMD_BF_Q        0x0505  //查询备份版本信息
#define CMD_EXIT_BOOT   0x0599 //退出Bootloader，进入APP
...
#define BAUD_CODE_4800           0x11
#define BAUD_CODE_9600           0x12
#define BAUD_CODE_19200          0x13
#define BAUD_CODE_115200         0x14
...
#define PROTOCOL_BROADCAST_ID      0xFFFF  //广播ID，表示发送给所有设备
